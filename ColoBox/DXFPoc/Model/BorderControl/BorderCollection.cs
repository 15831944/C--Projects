...
namespace DXFPoc.Model.BorderControl
{
    internal class BorderCollection : IEnumerable<Border>
    {
        ...
        protected DXFPoc.Model.LocationStatemachine.Machine locationMachine;
        ...
        internal virtual bool FindCollision(ColoBox boxToPlace)
        {
            ...
            foreach (var vx in lborders)
            {
                ...
                bool isTouchingOriginLines = locationMachine.direction.IsTouchingOriginLines(locationMachine,vx); 
        ...
        {
            double x = locationMachine.direction.CalculateNextLinearLocation(vx, boxToPlace, locationMachine.SpaceAfterObstacle);
